    ...
    return (
        ...
        >
            <div className="max-w-4xl mx-auto text-center">
                <div className="mb-6 relative max-h-[280px] overflow-hidden">
                    ...
                    {/* Hiệu ứng fade-out ở cuối phần mô tả */}
                    <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-background pointer-events-none"></div>
                </div>
